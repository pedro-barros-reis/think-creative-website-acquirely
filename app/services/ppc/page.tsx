...
import PPCValueSection from "@/components/sections/ppc/ValueSection";
...
export default function PPC() {
  return (
    <>
      ...
      <section
        aria-labelledby="testimonial-card"
        className="w-full mx-auto flex items-center justify-center bg-black pt-8 py-12 lg:py-30"
      >
        <Testimonial
          theme="dark"
