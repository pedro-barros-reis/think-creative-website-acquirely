...
import ValueSection from "@/components/sections/shared/ValueSection";
...
import SEOValueSection from "@/components/sections/seo/ValueSection";
...
export default function Seo() {
  return (
    <>
      ...
      <section
        aria-labelledby="testimonial-card"
        className="w-full mx-auto flex items-center justify-center bg-black pt-6 pb-12 lg:py-30"
      >
        <Testimonial
          theme="dark"
