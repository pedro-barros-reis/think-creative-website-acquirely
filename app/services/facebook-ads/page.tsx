...
import FacebookAdsValueSection from "@/components/sections/facebook-ads/ValueSection";
import FeaturesSection from "@/components/sections/facebook-ads/FeaturesSection";
import FacebookAdsHeroSection from "@/components/sections/facebook-ads/HeroSection";
import FacebookAdsProofSection from "@/components/sections/facebook-ads/ProofSection";
import { Testimonial } from "@/components/ui/TestimonialCard";
import { Metadata } from "next";
import Image from "next/image";

export const metadata: Metadata = {
  title: "Facebook Ads — Think Creative",
  description:
    "Grow your business with high-performing Facebook and Instagram ad campaigns managed by Think Creative. Reach your ideal audience and convert more customers.",
  openGraph: {
    title: "Facebook Ads — Think Creative",
    description: "Reach the right people. Drive real results.",
    type: "website",
  },
};
...
export default function FacebookAds() {
  return (
    <>
      ...
      <section
        aria-labelledby="testimonial-card"
        className="w-full mx-auto flex items-center justify-center bg-black pt-6 py-12 lg:py-30"
      >
        <Testimonial
          theme="dark"
