  ...
  return (
    <>
      ...
      <section
        ...
        className="w-full mx-auto flex flex-col items-center justify-center bg-[#000000] py-12 lg:py-30"
      >
        <h2
          id="testimonials-heading"
          className="text-center font-['Geist'] text-[32px] lg:text-[48px] font-semibold leading-[120%] tracking-[-2%] text-white mb-12 lg:mb-16"
        >
          What Others Think
        </h2>
        <Testimonial
