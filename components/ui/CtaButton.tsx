...
const BASE =
  "inline-flex items-center justify-center rounded-md bg-[#FF5F1F] px-8.75 py-5 font-['Geist'] text-[16px] md:text-[20px] font-bold uppercase leading-[100%] tracking-[-2%] text-white transition-colors hover:bg-[#C2410C] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF5F1F] focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-40";
